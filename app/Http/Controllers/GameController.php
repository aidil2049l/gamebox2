...
class GameController extends Controller
{
    ...
    public function storeUserGame(Request $request) {
        ...
        return redirect('/')->with('message', 'Twoje zgłoszenie zostało przyjęte!');
    }
    ...
    public function update(Request $request, Game $game) {
        ...
        return redirect('/admin-games')->with('message', 'Dane gry zostały zaktualizowane');
    }

    public function destroy(Game $game) {
        $game->delete();
        return redirect('/admin-games')->with('message', 'Gra została usunięta');
    }
    ...
    public function updateUserGames(Game $game)
    {
        ...
        return redirect('/')->with('message', 'Dodano do kolekcji');
    }
