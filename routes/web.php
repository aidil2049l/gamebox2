...
Route::get('/games/create', [GameController::class, 'create'])->name('admin-games.create')->middleware('role:Admin,Moderator');
...
Route::get('/games/{game}/edit', [GameController::class, 'edit'])->name('admin-games.edit')->middleware('role:Admin,Moderator');
...
Route::delete('/user-games/{game}', [GameController::class, 'removeUserGames'])->name('users.remove-user-games')->middleware('auth');
// Dodanie gry użytkownikowi
Route::put('/user-games/{game}', [GameController::class, 'updateUserGames'])->name('users.update-user-games')->middleware('auth');
